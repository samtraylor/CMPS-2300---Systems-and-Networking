...
they enter the randomly generated num inside specified range. The user 
will enter in a first name so that their score is saved in a file, the
same file from which the previous score is taken and displayed.
*/
...
int main(void) {
	printf("%d", guessing_game(-100,100));
	return 0;
}